...
while True:
    ...
    if float(a) == 1.1:
        print('A = ', a_collection)
        print('B = ', b_collection)
        print(f"Об'єднання: {ca.elems_in_a_or_b(a_collection, b_collection)}")
    elif float(a) == 1.2:
        print('A = ', a_collection)
        print('B = ', b_collection)
        print(f"Перетин: {ca.elems_in_a_and_b(a_collection, b_collection)}")
    elif float(a) == 1.3:
        print('A = ', a_collection)
        print('B = ', b_collection)
        print(f"Різниця множин A i B: {ca.elems_in_a_and_not_b(a_collection, b_collection)}")
    elif float(a) == 1.4:
        print('A = ', a_collection)
        print('B = ', b_collection)
        print(f"Різниця множин B i A: {ca.elems_in_a_and_not_b(b_collection, a_collection)}")
    elif float(a) == 1.5:
        print('U = ', u_collection)
        print('A = ', a_collection)
        print(f"Доповнення множини A: {ca.elems_in_u_not_in_a(u_collection, a_collection)}")
    elif float(a) == 1.6:
        print('U = ', u_collection)
        print('B = ', b_collection)
        print(f"Доповнення множини В: {ca.elems_in_u_not_in_a(u_collection, b_collection)}")
    elif float(a) == 1.7:
        print('A = ', a_collection)
        print('B = ', b_collection)
        print(f"Симетрична різниця множин А і B: {ca.elems_in_a_and_b_but_not_both(a_collection, b_collection)}")
    elif float(a) == 1.8:
        print('A = ', a_collection)
        print('B = ', b_collection)
        ...
        print('В = ', b_collection)
        print('А = ', a_collection)
